...
#Movie Button Description

# OUTPUT_PATH = Path(__file__).parent
# ASSETS_PATH = OUTPUT_PATH / Path(r"E:\course\tkinter proj\MMS\build\assets\frame6")


# def relative_to_assets(path: str) -> Path:
#     return ASSETS_PATH / Path(path)

# frame6 = tk.Frame(window,bg="#13101D")
...
# back6 = PhotoImage(
#     file=relative_to_assets("back_6.png"))
# back_6 =tk.Button(
#     frame6,
#     image=back6,
#     borderwidth=0,
...
# The_Dark_Knight = PhotoImage(
#     file=relative_to_assets("The-Dark-Knight-2008.png"))
# label = tk.Label(frame6, image=The_Dark_Knight)
# label.place(y=146,x=50,height=400,width=1280)
frame1.tkraise()
